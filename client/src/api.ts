...
const DIRECT_OBJECT_UPLOAD_LARGE_FILE_CONCURRENCY = 5;
const DIRECT_OBJECT_UPLOAD_HUGE_FILE_CONCURRENCY = 3;
...
const MULTIPART_PART_CONCURRENCY = 5;
const MULTIPART_PART_RETRIES = 5;
const DIRECT_OBJECT_GLOBAL_CONNECTION_LIMIT = 16;
const ADAPTIVE_UPLOAD_MIN_CONCURRENCY = 2;
const ADAPTIVE_UPLOAD_MAX_CONCURRENCY = 16;
