...
export type AppRoute = 'home' | 'plans' | 'studio' | 'admin';
export type AdminConsolePage = 'dashboard' | 'users' | 'works' | 'orders' | 'plans' | 'codes' | 'engine' | 'prompts' | 'content' | 'logs' | 'settings';
