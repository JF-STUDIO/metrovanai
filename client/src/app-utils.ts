...
export type AdminConsolePage = 'dashboard' | 'users' | 'works' | 'failures' | 'orders' | 'billing' | 'costs' | 'regenerationAudit' | 'plans' | 'codes' | 'engine' | 'prompts' | 'content' | 'maintenance' | 'logs' | 'settings';
