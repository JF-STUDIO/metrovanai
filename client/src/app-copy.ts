...
export const UI_TEXT = {
  zh: {
    ...
    authEmailNotVerified: '邮箱还没有验证。我们已重新发送验证码，请先输入邮件里的 6 位数字。',
    ...
    authSubtitleSignup: '新用户免费送 3 积分，试用下载为 1024px 并带 Metrovan AI 标识。',
    authSubtitleResetRequest: '输入注册邮箱，我们会发送一封密码重置邮件。',
    authSubtitleResetConfirm: '请输入新密码，完成后可以重新登录。',
    authSubtitleVerifyEmail: '请输入邮件里的 6 位验证码完成邮箱验证。',
    ...
    authVerificationCodePlaceholder: '输入 6 位验证码',
    ...
    authVerifyTokenMissing: '请输入邮箱和邮件里的 6 位验证码。',
    authPasswordMismatch: '两次密码输入不一致。',
    authRateLimited: '尝试次数过多，请稍后再试。',
    authVerificationEmailSent: '验证码已发送，请输入邮件里的 6 位数字。',
    authEmailVerifiedSuccess: '邮箱验证成功，正在进入工作台。',
    authVerifyInvalidOrExpired: '验证码无效或已过期，请重新发送验证邮件。',
    ...
    stripeInvoiceLink: 'Invoice',
    stripeInvoicePdfLink: '下载 Invoice PDF',
    stripeDocumentsPending: 'Invoice 生成中，稍后刷新账单即可查看。',
    ...
    uploadRawSidecarFiles: (count: number) => `已自动忽略 ${count} 个同名 JPG 副本，优先使用 RAW 原片。`,
    ...
    clickToView: '点击查看大图',
    missingResults: '缺失结果',
    missingResultsHint: '这些照片组还没有对应的结果图，可在管理员后台检查或重新处理。',
    missingResultStatus: '缺少结果图',
    colorCardNo: '目标色卡',
  ...
  en: {
    ...
    authEmailNotVerified: 'This email is not verified yet. We sent a new verification code. Enter the 6-digit code from your inbox.',
    ...
    authSubtitleSignup: 'New accounts include 3 trial credits. Trial downloads are 1024px with Metrovan AI branding.',
    ...
    authSubtitleVerifyEmail: 'Enter the 6-digit code from your email to verify your account.',
    ...
    authVerificationCode: 'Email verification code',
    authVerificationCodePlaceholder: 'Enter 6-digit code',
    ...
    authVerifyTokenMissing: 'Enter your email and the 6-digit verification code from your inbox.',
    authPasswordMismatch: 'Passwords do not match.',
    authRateLimited: 'Too many attempts. Please try again later.',
    authVerificationEmailSent: 'Verification code sent. Enter the 6-digit code from your email.',
    authEmailVerifiedSuccess: 'Email verified. Redirecting to your workspace.',
    authVerifyInvalidOrExpired: 'This verification code is invalid or expired. Send a new verification email.',
    ...
    stripeDocumentsPending: 'Invoice is being generated. Refresh billing shortly to view it.',
    ...
    uploadRawSidecarFiles: (count: number) => `${count} matching JPG sidecar file${count === 1 ? '' : 's'} ignored so the RAW original is used.`,
    ...
    missingResultsHint: 'These photo groups do not have a matching finished image yet. Check admin or reprocess them.',
    missingResultStatus: 'Missing finished image',
